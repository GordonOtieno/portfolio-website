      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <ul class="tech-list model">
            <li type="button" class="skills">html</li>
            <li type="button" class="skills">bootstrap</li>
            <li type="button" class="skills">ruby</li>
        </ul>
        </div>
        <div class="image-prag-container">
          ...
          <div class="modol-pb-container">
            ...
            <div class="modal-buttons">
              <button type="button" class="btn btn-default" >See Live<i class="fa fa-external-link" aria-hidden="true"></i></button>
              <button type="button" class="btn btn-default" >See Source<i class="fa fa-github" aria-hidden="true"></i></button>
            </div>
          </div>
        </div>
        </div>
